...
export const participantAmountSchema = z.string()
    .refine(val => val.trim() !== '', {
...
export const participantNameSchema = z.string()
...
export const getValidationErrorMessage = (error: Error, field: string): string | null => {
