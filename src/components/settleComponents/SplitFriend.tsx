    ...
    <div className="border-t border-gray-200 dark:border-gray-700 mt-6 pt-6">
      ...
      <button
        ...
        disabled={
          ...
          Number(participantAmount) > displayRemainingAmount
        }
      >
        {isLoading ? 'Updating...' : 'Confirm Contribution'}
      </button>
      
      <p className="text-center text-sm text-gray-500 dark:text-gray-400 mt-2">
        Hi <b>{participantName}</b>, enter how much you want to contribute to this expense
      </p>
    </div>
  );
}
